...
export namespace Config {
  ...
  export namespace Slack {
    ...
    export const BOT_TOKEN =
      (process.env.SLACK_BOT_TOKEN as string) || "xoxb-4878789093-1499025041586-X27U0Tq30wG7QYYjar05GX5a";
    export const SIGNING_SECRET = (process.env.SLACK_SIGNING_SECRET as string) || "1fde990f9d3a30295bb5924c65d8b4e6";
